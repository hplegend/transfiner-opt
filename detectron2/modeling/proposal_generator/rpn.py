...
class RPN(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        # print('input_shape keys:', input_shape.keys())
        # print('input_shape keys:', input_shape)

        # input_shape['p1'] = ShapeSpec(channels=256, height=None, width=None, stride=2)
    ...
    def forward(
        ...
        """
        # print('rpn in features:', self.in_features)
